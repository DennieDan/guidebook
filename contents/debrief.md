<span id="title" class="d-none">Debrief</span>
<frontmatter>
title: Debrief
...
<panel expanded>
    ...
    <panel>
        ...
        <li>Just now, Adam asked me if he could make up some details in his story. I would say it depends on each situation. If you want to tell your parents what happened at your basketball training today, you should tell all the truth, but if it is a fairy tale you want to write on your blog, you are free to make it up. It would be better if you have a small notes for your readers.</li>
...
<panel expanded>
    ...
    <panel>
        ...
        <li>When we paired up, some pairs did not even talk. Could I please ask what happened?</li>
        <li>Do you like working in groups or on your own?</li>
        <li>Do you think this lesson is fun? <i>(Don't be shy to ask this kind of question. The responses can be a bit painful but it is good to receive feedback and improve.)</i></li>
    </panel>
...
This part is optional but recommended to give mentees food-for-thought. The "assignment" should be able to be completed in 15 minutes, in average. For example:
